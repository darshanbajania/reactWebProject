...
function AiTool() {
  ...
  const getSearchCount = async () => {
    await fetch(
      "https://reactwebproject-b5eb4-default-rtdb.firebaseio.com/chatgptmathsolver/searches.json",
      {
        method: "GET",
      }
    )
  ...
  const updateUser = async () => {
    let userCount = 0;
    await fetch(
      "https://reactwebproject-b5eb4-default-rtdb.firebaseio.com/chatgptmathsolver/visitors.json",
      {
        method: "GET",
      }
    )
  ...
  const addQuestion = async (quesData) => {
    ...
    //     })
    await fetch(
      "https://reactwebproject-b5eb4-default-rtdb.firebaseio.com/chatgptmathsolver/questions.json",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  const getTokenCount = async () => {
    await fetch(
      "https://reactwebproject-b5eb4-default-rtdb.firebaseio.com/chatgptmathsolver/tokens.json",
      {
        method: "GET",
      }
    )
  ...
  const getSolution = async () => {
    try {
      await fetch("https://starter-express-api-tamb.onrender.com/solve/", {
  ...
  const handleSubmit = async (e) => {
    ...
    window.grecaptcha.ready(function () {
      window.grecaptcha
        .execute("6LfvcJ8jAAAAADRPrpBz-GyOqeJXs2sFc2OO8gj7", {
          action: "submit",
        })
        .then(async (token) => {
          ...
          try {
            await fetch("https://starter-express-api-tamb.onrender.com", {
              ...
              .then((data) => {
                ...
                if (true) {
                  if (true) {
                    ...
                    setQueryText("");
                    console.log("get solution called");
                    getSolution();
                  } else {
    ...
    >
          ...
          <form onSubmit={handleSubmit}>
            <div className="search-box">
              <input
                ...
                type={"text"}
                placeholder={"What is the sqaure root of 255?"}
              />
              ...
              {loading ? (
                ...
                <button type="submit">
                  ...
                  >
                    <path
                      d="M3.35001 35L38.3333 20L3.35001 5L3.33334 16.6667L28.3333 20L3.33334 23.3333L3.35001 35Z"
                      fill="#1B1818"
                    />
                  </svg>
                </button>
      ...
      <footer>
        ...
        <div className="disclaimer">
          <p>
            This website is meant for work and fun, please do not use it for
